...
export class OptionPermissionsComponent {
	...
	selShow (s: string) {
		if (s == 'department_sel') {
			...
			this.permissions_in_sel.isShow = false;
			...
			this.number_sel.isShow = false;
			this.permissions_in_sel.isShow = false;
		} else if (s == 'permissions_in_sel') {
			this.permissions_in_sel.isShow = !this.permissions_in_sel.isShow;
			this.department_sel.isShow = false;
			this.office_sel.isShow = false;
			this.permissions_sel.isShow = false;
			this.number_sel.isShow = false;
	...
	selHandler (s: any) {
		if (s.name == 'department_sel') {
			...
			this.position_sel.isShow = false;
		} else if (s.name == 'permissions_in_sel') {
			this.permissions_in_sel.title = s.title;
			this.permissions_in_sel.isShow = false;
		}
	}
	...
	onClick (event: MouseEvent) {
		...
		if (this.number_sel.isShow) {
			this.number_sel.isShow = false;
		}
		if (this.permissions_sel.isShow) {
			this.permissions_sel.isShow = false;
		}
		if (this.position_sel.isShow) {
			this.position_sel.isShow = false;
		}

		if (this.department_sel.isShow) {
			this.department_sel.isShow = false;
		}
		if (this.office_sel.isShow) {
			this.office_sel.isShow = false;
		}
		if (this.permissions_in_sel.isShow) {
			this.permissions_in_sel.isShow = false;
		}
	}
}
