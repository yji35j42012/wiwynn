...
export class OptionDeviceComponent {
  ...
  selCheckHandler(i: number) {
    if (this.stations_sel.lists[i].isChecked) {
      console.log('a');
      this.stations_sel.lists[i].isChecked = false;
      ...
      console.log('b');
      this.stations_sel.lists[i].isChecked = true;
      this.stations_sel.showLists.push(this.stations_sel.lists[i]);
    }
  }
